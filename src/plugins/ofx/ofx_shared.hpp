...
constexpr const char* kParamExecutionEngine = "execution_engine";
...
struct InstanceData {
    ...
    OfxParamHandle execution_engine_param = nullptr;
    ...
    ExecutionEngine requested_execution_engine = ExecutionEngine::Auto;
    ExecutionEngine active_execution_engine = ExecutionEngine::Auto;
...
std::optional<QualityArtifactSelection> select_quality_artifact(
    ...
    int input_width, int input_height, int quantization_mode, std::int64_t available_memory_mb = 0,
