...
function Write-ReleaseReadme {
    ...
    $modelCoverageText = switch ($ModelProfile) {
        "windows-rtx" { "This Windows RTX package includes the dynamic LibTorch/TorchTRT .ts runtime contract recorded in CorridorKey.ofx.bundle\\model_inventory.json." }
