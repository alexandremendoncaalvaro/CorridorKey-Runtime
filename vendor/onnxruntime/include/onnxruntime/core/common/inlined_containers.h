...
class InlinedHashSet
    : public absl::flat_hash_set<T, absl::container_internal::hash_default_hash<T>,
...
class InlinedHashMap
    : public absl::flat_hash_map<Key, Value, absl::container_internal::hash_default_hash<Key>,
...
template <typename T, typename Allocator>
class NodeHashSet
    : public absl::node_hash_set<T, absl::container_internal::hash_default_hash<T>,
                                 absl::container_internal::hash_default_eq<T>, Allocator> {
...
template <typename Key, typename Value, typename Allocator>
class NodeHashMap
    : public absl::node_hash_map<Key, Value, absl::container_internal::hash_default_hash<Key>,
                                 absl::container_internal::hash_default_eq<Key>, Allocator> {
...
template <typename Key, typename Value, typename Allocator>
class InlinedHashMap
    : public std::unordered_map<Key, Value, std::hash<Key>, std::equal_to<Key>, Allocator> {
