...
/**
   ...
   and not what is pointed too. i.e. you get a const pointer to T not a pointer to const T without
   this wrapper. See
   https://stackoverflow.com/questions/8017036/understanding-const-iterator-with-pointers
*/
   ...
   public:
    ...
    class ConstIterator {
       public:
        ...
        explicit ConstIterator(const_iterator position) noexcept
            : current_{position}, item_{nullptr} {}
    ...
    /**
       Construct wrapper class that will provide const access to the pointers in a container of
       non-const pointers.
