...
// Eigen::DefaultDevice>::type {aka __vector(4) float}" [-Werror=ignored-attributes]
#if defined(__GNUC__)
...
// error: 'result_of<Eigen::internal::scalar_product_op<unsigned long long> (const unsigned long
// long &, const unsigned long long &)>' is deprecated [-Werror,-Wdeprecated-declarations]
...
// warning C4554: '&': check operator precedence for possible error; use parentheses to clarify
// precedence

// unsupported\eigen\cxx11\src\Tensor\TensorUInt128.h(150,0): Warning C4245: 'initializing':
