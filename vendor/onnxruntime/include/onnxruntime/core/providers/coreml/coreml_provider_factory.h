...
static const char* const kCoremlProviderOption_RequireStaticInputShapes =
    "RequireStaticInputShapes";
static const char* const kCoremlProviderOption_EnableOnSubgraphs = "EnableOnSubgraphs";
// provided by
// https://developer.apple.com/documentation/coreml/mloptimizationhints-swift.struct/specializationstrategy-swift.property
// Core ML segments the model’s compute graph and specializes each segment for the target compute
// device. This process can affect the model loading time and the prediction latency. Use this
// option to tailor the specialization strategy for your model.
...
// Intended for developer usage but provide useful diagnostic information if performance is not as
// expected.
static const char* const kCoremlProviderOption_ProfileComputePlan = "ProfileComputePlan";
// please refer to
// https://developer.apple.com/documentation/coreml/mlmodelconfiguration/allowlowprecisionaccumulationongpu
static const char* const kCoremlProviderOption_AllowLowPrecisionAccumulationOnGPU =
...
// If this path is not specified, the model will be saved to a temp directory and deleted after the
// session is closed. otherwise, the model will be saved to the specified path and User should
// manage to delete the model.
...
// Please find out how to set metadata_props in the onnxruntime API documentation.
// https://onnxruntime.ai/docs/execution-providers/CoreML-ExecutionProvider.html#configuration-options
