...
struct Int4x2Base {
    ...
    /// <summary>
    /// Copy a source buffer of 4-bit elements (packed) into a destination buffer of 8-bit elements
    /// (unpacked).
    /// </summary>
    ...
    /// <summary>
    /// Copy a source buffer of 8-bit elements (unpacked) into a destination buffer of 4-bit
    /// elements (packed).
    /// </summary>
