...
class OpKernelContext {
   public:
    ...
    OpKernelContext(_Inout_ IExecutionFrame* frame, _In_ const OpKernel* kernel,
                    _In_ Stream* stream, _In_opt_ concurrency::ThreadPool* threadpool,
    ...
    */
    ...
    TODO(leca): Replace GetTempSpaceAllocator() and GetTempSpaceCPUAllocator() with this API in the
    future
    */
