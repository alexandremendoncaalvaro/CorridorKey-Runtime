...
// Optional metadata key to determine if a OrtHardwareDevice represents a virtual (non-hardware)
// device. Possible values:
//  - "0": OrtHardwareDevice is not virtual (i.e., actual hardware device). This is the assumed
//  default value
