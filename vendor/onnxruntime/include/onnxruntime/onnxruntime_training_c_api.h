...
struct OrtTrainingApi {
     ...
     * point for training. \param[in] train_model_path Model to be used to perform training.
     ...
     * \param[in] options Session options that the user can customize for this training session.
     * \param[in] checkpoint_state Training states that the training session uses as a starting
     * point for training. \param[in] train_model_data Buffer containing the model data to be used
     * to perform training \param[in] train_data_length Length of the buffer containing
     * train_model_data \param[in] eval_model_data Buffer containing the model data to be used to
     * perform evaluation \param[in] eval_data_length Length of the buffer containing
     * eval_model_data \param[in] optim_model_data Buffer containing the model data to be used to
     * perform weight update \param[in] optim_data_length Length of the buffer containing
     * optim_model_data \param[out] out Created training session.
     *
     */
     ...
     * function to OrtTrainingApi::CopyBufferToParameters and can be used to load updated buffer
     * values onto the training state. Parameter ordering is preserved. User is responsible for
     * allocating and freeing the resources used by the parameters_buffer.
     *
     * \param[in] sess The `this` pointer to the training session.
     * \param[in] trainable_only Whether to skip non-trainable parameters
     ...
     * inferencing with InferenceSession. \note Note that the function re-loads the eval model from
     * the path provided to OrtTrainingApi::CreateTrainingSession and expects that this path still
     * be valid.
     *
     * \param[in] sess The `this` pointer to the training session.
