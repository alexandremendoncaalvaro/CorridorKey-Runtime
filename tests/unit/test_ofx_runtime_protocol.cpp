...
TEST_CASE("ofx runtime protocol roundtrips session payloads", "[unit][ofx][runtime]") {
    ...
    prepare_request.engine_options.execution_engine = ExecutionEngine::TorchTensorRt;
    ...
    CHECK(parsed_prepare->engine_options.execution_engine == ExecutionEngine::TorchTensorRt);
    ...
    snapshot.requested_engine = ExecutionEngine::TorchTensorRt;
    ...
    CHECK(parsed_snapshot->requested_engine == ExecutionEngine::TorchTensorRt);
