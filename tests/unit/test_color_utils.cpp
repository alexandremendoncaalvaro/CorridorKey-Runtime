...
TEST_CASE("ColorUtils::premultiply and unpremultiply", "[unit][color]") {
    ...
    rgb.data[0] = 1.0f; rgb.data[1] = 0.5f; rgb.data[2] = 0.2f;
    ...
    SECTION("Unpremultiply") {
        rgb.data[0] = 0.5f; rgb.data[1] = 0.25f; rgb.data[2] = 0.1f;
...
TEST_CASE("ColorUtils::resize bilinear", "[unit][color]") {
    ...
    // 0.0  1.0
    // 1.0  0.0
    img.data[0] = 0.0f; img.data[1] = 1.0f; img.data[2] = 1.0f; img.data[3] = 0.0f;
